    ...
    >
      ...
      <div className="w-full max-w-md bg-white/40 border border-white/60 backdrop-blur-2xl shadow-xl rounded-3xl p-8 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-neutral-charcoal tracking-tight mt-2">Get Started</h2>
          <p className="text-sm text-neutral-mediumgray font-semibold mt-1">Create an account to build AI search apps in minutes</p>
        </div>
